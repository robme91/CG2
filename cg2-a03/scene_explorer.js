 ...
 * With a contribution (bug fix) from Johannes Grassler
 *
 ...
 * for comparing two renderings of the same scene.
 *
 */
...
define(["gl-matrix" ], 
    ...
    /* 
        ...
        - canvas object that will trigger the keyboard/mouse events 
        ...
        - scene to be drawn in that canvas, must have a draw() method 
          with no arguments
        - optional second scene to be manipulated in sync with 
          first scene
    ...
    */
    ...
    var SceneExplorer = function(canvas, triggerRedraw, scene, scene2) {
        ...
        // change these factors as you like! 
    ...
    SceneExplorer.prototype.continueDragging = function(x, y) {
        ...
        // decide whether to rotate, translate, or zoom
        if(this.dragMode == "rotate") {
            
            /////////////////////////////////////////////////////////////
            // rotate by modifiying scene.worldTransformation 
            /////////////////////////////////////////////////////////////
            ...
            var modelToEye = mat4.create(this.scene.cameraTransformation);
            ...
            mat4.multiply(rotX, this.scene.worldTransformation, 
                                this.scene.worldTransformation);
            mat4.multiply(rotY, this.scene.worldTransformation, 
                                this.scene.worldTransformation);
            
        } else if(this.dragMode == "translateXY") {

            /////////////////////////////////////////////////////////////////////////
            // translate along camera X or Y by modifiying scene.cameraTransformation
            /////////////////////////////////////////////////////////////////////////
            
            // translation vector in eye coords
            var trans = vec3.create([deltaX*this.transSensitivity, -deltaY*this.transSensitivity, 0]);
            mat4.translate(this.scene.cameraTransformation, trans);
            
        } else if(this.dragMode == "translateZ") {

            /////////////////////////////////////////////////////////////////////////
            // translate along camera Z by modifiying scene.cameraTransformation
            // TODO: works only in perspective projection mode!!!
            /////////////////////////////////////////////////////////////////////////
        ...
        if(this.scene2 != undefined) {
            this.scene2.worldTransformation = mat4.create(this.scene.worldTransformation);
            this.scene2.cameraTransformation = mat4.create(this.scene.cameraTransformation);
        };
